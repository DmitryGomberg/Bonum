...
class TransactionsController {
    async createNew(req, res) {
        try {
            const { description, date, type_id, category_id, account_id, user_id, sum, account_to_id } = req.body;

            const newTransaction = await db.query(
                `INSERT INTO transactions (description, date, type_id, category_id, account_id, user_id, sum, account_to_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
                [description, date, type_id, category_id, account_id, user_id, sum, account_to_id]
            );
